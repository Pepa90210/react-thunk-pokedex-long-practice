...
import { createNewPokemon, getPokemonTypes } from '../store/pokemon';
...
const CreatePokemonForm = ({ hideForm }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    let createdPokemon = await dispatch(createNewPokemon(payload))
    // console.log('createdPokemon in handleSubmit from form', createdPokemon)
    if (createdPokemon) {
